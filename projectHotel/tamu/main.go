...
import (
	...
	ep "projectHotel/hotel/tamu/endpoint"
...
func main() {
	...
	var server pb.TamuServiceServer
	{
		...
		service := svc.NewTamu(dbReadWriter)
		endpoint := ep.NewTamuEndpoint(service)
		fmt.Println(endpoint)
		server = ep.NewGRPCTamuServer(endpoint, tracer, logger)
	}
	...
	pb.RegisterTamuServiceServer(grpcServer, server)
