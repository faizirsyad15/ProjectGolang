...
import (
	...
	ep "projectHotel/hotel/jenisPembayaran/endpoint"
...
func main() {
	...
	var server pb.JenisPembayaranServiceServer
	{
		...
		service := svc.NewJenisPembayaran(dbReadWriter)
		endpoint := ep.NewJenisPembayaranEndpoint(service)
		fmt.Println(endpoint)
		server = ep.NewGRPCJenisPembayaranServer(endpoint, tracer, logger)
	}
	...
	pb.RegisterJenisPembayaranServiceServer(grpcServer, server)
