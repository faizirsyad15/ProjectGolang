...
import (
	...
	ep "projectHotel/hotel/alamat/endpoint"
...
func main() {
	...
	var server pb.AlamatServiceServer
	{
		...
		service := svc.NewAlamat(dbReadWriter)
		endpoint := ep.NewAlamatEndpoint(service)
		fmt.Println(endpoint)
		server = ep.NewGRPCAlamatServer(endpoint, tracer, logger)
	}
	...
	pb.RegisterAlamatServiceServer(grpcServer, server)
