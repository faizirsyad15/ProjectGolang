...
import (
	...
	ep "projectHotel/hotel/kontrak/endpoint"
...
func main() {
	...
	var server pb.KontrakServiceServer
	{
		...
		service := svc.NewKontrak(dbReadWriter)
		endpoint := ep.NewKontrakEndpoint(service)
		fmt.Println(endpoint)
		server = ep.NewGRPCKontrakServer(endpoint, tracer, logger)
	}
	...
	pb.RegisterKontrakServiceServer(grpcServer, server)
