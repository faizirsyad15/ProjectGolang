...
import (
	...
	ep "projectHotel/hotel/golongan/endpoint"
...
func main() {
	...
	var server pb.GolonganServiceServer
	{
		...
		service := svc.NewGolongan(dbReadWriter)
		endpoint := ep.NewGolonganEndpoint(service)
		fmt.Println(endpoint)
		server = ep.NewGRPCGolonganServer(endpoint, tracer, logger)
	}
	...
	pb.RegisterGolonganServiceServer(grpcServer, server)
