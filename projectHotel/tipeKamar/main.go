...
import (
	...
	ep "projectHotel/hotel/tipeKamar/endpoint"
...
func main() {
	...
	var server pb.TipeKamarServiceServer
	{
		...
		service := svc.NewTipeKamar(dbReadWriter)
		endpoint := ep.NewTipeKamarEndpoint(service)
		fmt.Println(endpoint)
		server = ep.NewGRPCTipeKamarServer(endpoint, tracer, logger)
	}
	...
	pb.RegisterTipeKamarServiceServer(grpcServer, server)
